...
const LeftComp = () => {
  return (
       <div style={{backgroundColor:'#5c9ce5', width:'25%', height:'100vh'}}>
            <div style={{display:'flex',marginBottom:'25px',paddingTop:'25px',marginLeft:'35px'}}>
            ...
            <div style={{marginBottom:'0px',padding:'0px'}}>
                ...
                <div style={{display:'flex',alignItems:'center',justifyContent:'center'}}>
                    ...
                    <div>
                        <img src={Sunset} width={'25px'} height={'30px'} style={{marginTop:'0px'}}/>
            ...
            <img src={Central} width={'120%'} style={{position:'relative',left:'-10%',top:'13%' }} />
       </div>
  )
}
